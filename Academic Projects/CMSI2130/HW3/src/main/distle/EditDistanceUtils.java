...
public class EditDistanceUtils {
    ...
    public static int[][] getEditDistTable (String s0, String s1) {
        // >> [TN] Some of the inline comments 
    ...
    private static List<String> recursiveHelper(int row, int col, List<String> list, String s0, String s1) {
        ...
        // >> [TN] There's a bit of repeated code in the rest of the function. You can achieve
        // the same result with some better logic. (-1)
...
// the Distle player is also good. 
// Some of the inline comments aren't really needed with the complexity of the code
// it is trying to describe.
// Additionally, the transformation list method has a bit of repeated code
// that could be avoided with different logic.
// Otherwise, good job!
// --------------------------------------------------- 
// >>> [TN] Style Checklist
...
// -> DistlePlayer:     261 / 265 (-0.5 / below threshold; max -25)
// Style Penalty:       -1
// Total:               97 / 100
// ===================================================