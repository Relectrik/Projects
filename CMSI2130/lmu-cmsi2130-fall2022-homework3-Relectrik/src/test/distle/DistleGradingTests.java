...
public class DistleGradingTests {
    ...
    private void runGameShowRounds (String dictionaryPath, String testName) throws FileNotFoundException {
        DistleGame game = new DistleGame(dictionaryPath, false, new DistlePlayer(), SEED);
    ...
    public void distlePlayer_t14() throws FileNotFoundException {
        runGameShowRounds("/Users/Viv/documents/cmsi2130/lmu-cmsi2130-fall2022-homework3-relectrik/src/dat/distle/dictionary14.txt", "Dictionary14");
        System.out.println("  [>] Benchmark: ~95% Won");
    }
    
    @Test
    public void distlePlayer_t10() throws FileNotFoundException {
        runGameShowRounds("/Users/Viv/documents/cmsi2130/lmu-cmsi2130-fall2022-homework3-relectrik/src/dat/distle/dictionary10.txt", "Dictionary10");
        System.out.println("  [>] Benchmark: ~90% Won");
    }
    
    @Test
    public void distlePlayer_t6() throws FileNotFoundException {
        runGameShowRounds("/Users/Viv/documents/cmsi2130/lmu-cmsi2130-fall2022-homework3-relectrik/src/dat/distle/dictionary6.txt", "Dictionary6");
